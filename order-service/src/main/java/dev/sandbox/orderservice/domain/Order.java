...
/**
 * Aggregate root - the transaction/consistency boundary for order creation. Owns its own
 * invariants; {@link #create} is the only way to produce a valid instance.
 */
public final class Order {
  ...
  public boolean equals(Object o) {
    return this == o || (o instanceof Order other && orderId.equals(other.orderId));
  }
